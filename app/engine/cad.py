...
def revision_block(title: str, project: str, rev: str = "A") -> str:
    ...
    <g class='title-block' font-family='Inter, Arial'>
      ...
      <text x='700' y='672' fill='#55c8ff' font-size='17' font-weight='800'>CONTROLPRO ADVISOR OS V16</text>
...
def cad_grid() -> str:
    ...
    <rect width='1200' height='800' fill='#061019'/><rect x='36' y='36' width='1128' height='44' rx='10' fill='#0e2b3f' stroke='#55c8ff' stroke-width='1'/><text x='58' y='64' fill='#dff7ff' font-family='Inter,Arial' font-size='18' font-weight='800'>MARKETVISION PRO · PLANO CAD-LIKE PREMIUM · VALIDAR ANTES DE FABRICAR</text>
...
<svg viewBox='0 0 1200 800' xmlns='http://www.w3.org/2000/svg' role='img' aria-label='Layout tablero CAD-like'>
  ...
  <text x='170' y='642' class='warn'>FitLock Pro: layout, borneras, cables y Draw.io obedecen la arquitectura principal; no mezclar VFD con KM1/KM2.</text>
...
def drawio_xml(i: ProjectIntake, calc: Dict[str, Any], architecture: Dict[str, Any] | str | None = None) -> str:
    ...
    return f'''<mxfile host="ControlPro" modified="{datetime.now(timezone.utc).isoformat()}" agent="ControlPro Advisor OS V16" version="24.0.0">
  <diagram id="controlpro-e001" name="E-001 Unifilar {xml_escape(arch)}">
    <mxGraphModel dx="1200" dy="800" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="1169" pageHeight="827" math="0" shadow="0">
      <root>
        <mxCell id="0" />
        <mxCell id="1" parent="0" />
        <mxCell id="title" value="ControlPro OS V16 - {project} - {xml_escape(arch)}" style="text;html=1;strokeColor=none;fillColor=none;fontSize=18;fontStyle=1" vertex="1" parent="1"><mxGeometry x="40" y="30" width="700" height="40" as="geometry" /></mxCell>
        {cells}
      </root>
    </mxGraphModel>
  </diagram>
